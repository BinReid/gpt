...
from module.mo.error_window import show_error_message
from module.mo.play_screen import PlayScreen
from module.mo.settings_screen import SettingsScreen
from module.mo.loading_screen import LoadingScreen
from module.mo.about_screen import AboutScreen
from module.mo.session_manager import SessionManager  # Import SessionManager

from module.games.glass import GlassGame
from module.games.roulette import RouletteGame
from module.games.rps import RPSGame
...
class Game:
    ...
    def random_game_selection(self):
        """Случайный выбор мини-игры."""
        games = [GlassGame, RouletteGame, RPSGame]
    ...
    def load_game(self):
        ...
        try:
            ...
            show_error_message("Сохранение не найдено.")
            return None

    def start_new_session(self):
        """Start a new game session."""
        self.session_manager.reset_session()
        self.session_manager.select_random_game()
        self.session_manager.run_current_game()

    def load_session(self):
        """Load a previously saved session."""
        self.session_manager.load_game_state()
        # Logic to run the loaded game state
                ...
                for event in pygame.event.get():
                    ...
                    if in_play_screen:
                        ...
                        if result == "back":
                            ...
                            self.start_new_session()  # Start a new session
                        elif result == "stats":
